...
namespace SyskenTLib.LicenseMasterEditor
{
    public class ManageLicenseWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/LicenseMaster/CreateConfig", priority = 130)]
        ...
        [MenuItem("Tools/LicenseMaster/UpdateAllLicense", priority = 230)]
        ...
        [MenuItem("Tools/LicenseMaster/CreateEachLicenseMemo", priority = 330)]
